...
//class ResilientIPC : public IIPC {
//public:
//    ResilientIPC(
//        std::function<std::shared_ptr<IIPC>()> ipcFactory,
//        std::function<std::shared_ptr<ILogHandler>()> logHandlerFactory
//    );
//    ResilientIPC(std::function<std::shared_ptr<IIPC>()> factory);
//    ~ResilientIPC() override = default;
//
//    bool init() override;
